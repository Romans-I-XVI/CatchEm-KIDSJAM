    ...
    class Content
    {
		...
		public static class Textures
		{
			public static class Pokemon
			{
				...
				public const string haunter = @"textures/pokemon/haunter";
				public const string hitmonlee = @"textures/pokemon/hitmonlee";
			...
			public const string ball_1 = @"textures/ball_1";
			public const string ball_2 = @"textures/ball_2";
			public const string ball_3 = @"textures/ball_3";
			public const string ball_4 = @"textures/ball_4";
			public const string ball_5 = @"textures/ball_5";
